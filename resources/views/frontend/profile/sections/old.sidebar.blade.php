...
<style>
  ...
  .sidebar-mini .social-links a:first-child {
  ...
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="{{ localeRoute('home') }}">
        <img src="{{ asset('frontend/assets/img/logo.png') }}" alt="Profile logo"/>
      </a>
    </div>
    <div class="sidebar-brand sidebar-brand-sm">
      <a href="{{ localeRoute('home') }}">
        <img class="img_logo" src="{{ asset('frontend/assets/img/logo.png') }}" width="65px" alt="Profile logo"/>
      </a>
    </div>
    <ul class="sidebar-menu">


      <li class="{{ MenuHelper::check($controller,'company')}}">
        <a href="{{ localeRoute('frontend.profile.companies.index') }}" class="nav-link">
          <i class="fas fa-user-friends"></i><span>{{__('main.companies')}}</span>
        </a>
      </li>
      {{-- <li class="{{ MenuHelper::check($controller,'companycasse')}}">
           <a href="{{ localeRoute('frontend.profile.company_casse.index') }}" class="nav-link">
               <i class="fas fa-certificate"></i><span>{{__('main.casses')}}</span>
           </a>
       </li>
       <li class="{{ MenuHelper::check($controller,'companyinvoice')}}">
           <a href="{{ localeRoute('frontend.profile.company_invoice.index') }}" class="nav-link">
               <i class="fas fa-certificate"></i><span>{{__('main.company_invoices')}}</span>
           </a>
       </li>
        <li class="{{ MenuHelper::check($controller,'companywarehouse')}}">
           <a href="{{ localeRoute('frontend.profile.company_warehouse.index') }}" class="nav-link">
               <i class="fas fa-certificate"></i><span>{{__('main.warehouses')}}</span>
           </a>
       </li>
       <li class="{{ MenuHelper::check($controller,'companyikpu')}}">
           <a href="{{ localeRoute('frontend.profile.company_ikpu.index') }}" class="nav-link">
               <i class="fas fa-certificate"></i><span>{{__('main.ikpu')}}</span>
           </a>
       </li>--}}

      {{--  <li class="{{ MenuHelper::check($controller,'profile') }}">
           <a href="{{ localeRoute('frontend.profile.info') }}" class="nav-link">
               <i class="fas fa-info-circle"></i><span>{{__('main.information')}}</span>
           </a>
       </li>
 {{-- <li><a href="#" class="nav-link">
               <i class="fas fa-folder"></i><span>{{__('main.guide')}}</span>
           </a>

           <ul>
           <li class="{{ MenuHelper::check($controller,'company_invoices') }}">
               <a href="{{ localeRoute('frontend.profile.company-invoice.index') }}" class="nav-link">
                   <i class="fas fa-info-circle"></i><span>{{__('main.company_invoices')}}</span>
               </a>
           </li>
           </ul>
       </li>--}}
      ...
      {{--@isset($user->tarifs[0])
      @foreach($user->tarifs[0]->modules as $module) --}}

      {{-- временно показать все тарифы для любого пользователя--}}
      @isset($tarifs)
        @foreach($tarifs->modules as $module)
          ...
          @if($module->slug=='casses_order')
            ...
            <li class="@if($controller=='incomingorder' || $controller=='expenseorder') active @endif"><a href="{{ localeRoute("frontend.profile.modules.incoming_order.index") }}" class="nav-link">
                <i class="fas fa-folder"></i><span>{{$module->getTitle()}}</span>
              </a></li>

          @elseif($module->slug=='product')
            <li class="@if($owner=='incoming') {{ MenuHelper::check($controller,'document')}}@endif"><a href="{{ localeRoute("frontend.profile.modules.document.index",['owner'=>'incoming']) }}" class="nav-link">
                <i class="fas fa-folder"></i><span>{!! __('main.product_incoming')!!}</span>
              </a>
            </li>
            <li class="@if($owner=='outgoing') {{ MenuHelper::check($controller,'document')}}@endif"><a href="{{ localeRoute("frontend.profile.modules.document.index",['owner'=>'outgoing']) }}" class="nav-link">
                <i class="fas fa-folder"></i><span>{!! __('main.product_outgoing')!!}</span>
              </a>
            </li>

          @else
            <li class="{{ MenuHelper::check($controller,str_replace('_','',$module->slug))}}"><a href="{{ localeRoute("frontend.profile.modules.$module->slug.index") }}" class="nav-link">
                <i class="fas fa-folder"></i><span>{{$module->getTitle()}}</span>
              </a></li>
          @endif
      ...
      <li>
        <a href="#" class="nav-link">
          <i class="fas fa-folder"></i><span>Производство</span>
        </a>
      </li>
      <li>
        <a href="#" class="nav-link">
          <i class="fas fa-folder"></i><span>Основные средства</span>
        </a>
      </li>
      <li>
        <a href="#" class="nav-link">
          <i class="fas fa-folder"></i><span>Кадры</span>
        </a>
      </li>
      <li>
        <a href="#" class="nav-link">
          <i class="fas fa-folder"></i><span>Заработная плата</span>
        </a>
      </li>
      <li>
        <a href="#" class="nav-link">
          <i class="fas fa-folder"></i><span>Отчеты</span>
        </a>
      </li>
      ...
      <li>
        <a href="//soliq.uz" class="nav-link" target="_blank">
          <i class="fas fa-arrow-right"></i><span>soliq.uz</span>
        </a>
      </li>
      <li>
        <a href="//mehnat.uz" class="nav-link" target="_blank">
          <i class="fas fa-arrow-right"></i><span>mehnat.uz</span>
        </a>
      </li>
      <li>
        <a href="//stat.uz" class="nav-link" target="_blank">
          <i class="fas fa-arrow-right"></i><span>stat.uz</span>
        </a>
      </li>
      ...
      <li class="social-links justify-content-center">
        <a href="https://t.me/wombat" class="nav-link" target="_blank" title="telegram">
          <i class="fab fa-telegram-plane"></i>
        </a>
        <a href="https://facebook.com/wambat" class="nav-link" target="_blank" style="padding: 0px !important;" title="facebook">
