        ...
        <div class="px-4 py-6">
            @isset($company)
                ...
                <a href="{{localeRoute('frontend.profile.companies.edit',$company)}}">
                    <div
                        class="tab @if($menu=='requisites') active @endif flex gap-x-4 rounded-lg p-4 transition-all"
                        data-tab="tab1"
                    >
                        <div
            ...
            <a href="{{ localeRoute('frontend.profile.company_casse.index') }}">
                <div
                    class="tab @if($menu=='company_casse') active @endif flex gap-x-4 rounded-lg p-4 transition-all"
                    data-tab="tab2"
                >
                    <div
            ...
            <a href="{{ localeRoute('frontend.profile.company_warehouse.index') }}">
                <div
                    data-tab="tab3"
                    class="tab @if($menu=='company_warehouse') active @endif group flex gap-x-4 rounded-lg p-4 transition-all"
                >
                    <div
                        class="tab-icon inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-bgray-100 transition-all"
                    >
                    ...
                    <div>
                        ...
                        <p
                            class="mt-0.5 text-sm font-medium text-bgray-700 dark:text-darkblack-300"
                        >
                            {{ __('main.warehouses_desc') }}
                        </p>
                    </div>
                </div>
            </a>
            <a href="{{ localeRoute('frontend.profile.company_invoice.index') }}">
                <div
                    data-tab="tab4"
                    class="tab @if($menu=='company_invoice') active @endif group flex gap-x-4 rounded-lg p-4 transition-all"
                >
                    <div
                        class="tab-icon inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-bgray-100 transition-all"
                    >
                    ...
                    <div>
                        <h4
                            class="text-base font-bold text-bgray-900 dark:text-white"
                        >
                            {{ __('main.company_invoices') }}
                        </h4>
                        <p
                            class="mt-0.5 text-sm font-medium text-bgray-700 dark:text-darkblack-300"
                        >
                            {{ __('main.company_invoices_desc') }}
                        </p>
                    </div>
                </div>
            </a>
            <a href="{{ localeRoute('frontend.profile.company_ikpu.index') }}">
                <div
                    data-tab="tab5"
                    class="tab @if($menu=='company_ikpu') active @endif flex gap-x-4 rounded-lg p-4 transition-all"
                >
                    <div
                        class="tab-icon inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-bgray-100 transition-all"
                    >
            ...
            <a href="{{ localeRoute('frontend.profile.companies.services') }}">
                <div
                    data-tab="tab7"
                    class="tab @if($menu=='services') active @endif flex gap-x-4 rounded-lg p-4 transition-all"
                >
                    <div
                        class="tab-icon inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-bgray-100 transition-all"
                    >
...
{{--
<div class="col-12">
<span class="m-3"><b>{{$company->name}}</b></span>
<a href="{{ localeRoute('frontend.profile.companies.services') }}" class="btn-create">{{__('main.services')}}</a>
<a href="{{ localeRoute('frontend.profile.company_invoice.index') }}" class="btn-create">{{__('main.company_invoices')}}</a>
<a href="{{ localeRoute('frontend.profile.company_warehouse.index') }}" class="btn-create">{{__('main.warehouses')}}</a>
<a href="{{ localeRoute('frontend.profile.company_casse.index') }}" class="btn-create">{{__('main.casses')}}</a>
<a href="{{ localeRoute('frontend.profile.companies.edit',$company) }}" class="btn-create">{{__('main.requisites')}}</a>
<a href="{{ localeRoute('frontend.profile.company_ikpu.index') }}" class="btn-create">{{__('main.ikpu')}}</a>
</div>--}}
