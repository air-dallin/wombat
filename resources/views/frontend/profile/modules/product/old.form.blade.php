                                ...
                                <select class="form-control" name="company_id" id="company_id" required>
                                    ...
                                    @isset($companies)
                                        ...
                                        @foreach($companies as $company)
                                            <option value="{{$company->id}}" @if( (isset($product) && $product->company_id==$company->id) || $company->id==$current_company) selected @endif >{{$company->name}}</option>
                                        @endforeach
                                    @endisset
                                </select>
                                @error('company_id')
...
--}}
                            ...
                            <div class="form-group col-4">
                                <label for="" class="form-label">{{__('main.facture_number')}}</label>
                                <input type="text" name="number" id="number" class="form-control @error('number') is-invalid @enderror" placeholder="" value="{{old('number',isset($product) ? $product->number : $new_number )}}" required>
                                @error('number')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group input-group mb-3">
                                        ...
                                        <input type="text" name="partner_inn" id="partner_inn" class="form-control @error('partner_inn') placeholder="{{__('main.enter_inn')}}" is-invalid @enderror" placeholder="{{__('main.enter_inn')}}" value="{{old('partner_inn',isset($product) ? $product->partner_inn :'')}}" required>
                                        @error('partner_inn')
                                        <small class="invalid-feedback"> {{ $message }} </small>
                                        @enderror
...
@section('js')
    <script>
        $(document).ready(function () {
            ...
            @isset($product)
                $('#company_id option[value={{$product->company_id}}]').change();
                $('#contract_id option[value={{$product->contract_id}}]').attr('selected', 'selected');
                getIkpu();
            @endisset
        });
