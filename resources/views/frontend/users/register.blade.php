            ...
            <div class="lg:w-1/2 px-5 xl:pl-12 pt-10">
                ...
                <div class="max-w-[450px] m-auto pt-24 pb-16">
                    ...
                    <div class="form-group step-phone">
                        <div class="mb-4">
                            ...
                            <div style="margin: 15px 0">
                                <label for="" class="bg-white dark:bg-darkblack-500 text-base text-bgray-600" style="margin-bottom: 10px; display:block;">{{__('main.inn')}}</label>
                                <input type="text" id="inn" class="inn text-bgray-800 text-base border border-bgray-300 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-white h-14 w-full focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base" value="">
                            </div>
                        </div>
                        <div class="step-btns">
                    ...
                    <p class="text-center text-bgray-900 dark:text-bgray-50 text-base font-medium pt-7">
                        ...
                        <a href="{{ localeRoute('frontend.login') }}" class="font-semibold underline">{{ __('main.login') }}</a>
                    </p>
