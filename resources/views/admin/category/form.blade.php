...
@section('content')
        ...
        /*<div class="page-titles">
                   <ol class="breadcrumb">
                       <li class="breadcrumb-item"><a href="javascript:void(0)">OldCategory</a></li>
                       <li class="breadcrumb-item active"><a href="javascript:void(0)">{{isset($category)?$category->getTitle():'' }}</a></li>
                   </ol>
               </div> */ ?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" enctype="multipart/form-data"
                              @isset($category)
                                  action="{{localeRoute('admin.category.update',$category)}}"
                              @else
                                  action="{{localeRoute('admin.category.store')}}"
                                @endisset
                        >
                            @csrf
                            @isset($category)
                                        ...
                                        <div class="pt-4">
                                            <div class="basic-form">
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    <input type="text" class="h-14 rounded-lg border-0 bg-bgray-50 p-4 focus:border focus:ring-0 dark:bg-darkblack-500 dark:text-white" name="title_ru" value="{{ old('title_ru',isset($category)?$category->title_ru:'') }}" required>
                                                    @error('title_ru')
                                        ...
                                        <div class="pt-4">
                                            <div class="basic-form">
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    <input type="text" class="form-control" name="title_uz" value="{{ old('title_uz',isset($category)?$category->title_uz:'') }}">
                                                    @error('title_uz')
                                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="pt-4">
                                            <div class="basic-form">
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    <input type="text" class="form-control" name="title_en" value="{{ old('title_en',isset($category)?$category->title_en:'') }}">
                                                    @error('title_en')
                                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
